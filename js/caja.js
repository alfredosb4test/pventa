		...
		$("#dialog_generico").dialog({
			...
			buttons: {					  
			  ...
			  Guardar: function() {
				...
				$item_nombre =  '<div class="item_nombre f_left"><img src="images/borrar2.png" width="25" height="25" onclick="del_item(\''+$codigo+'\')" class="hand" style="top: 5px; position: relative;"><span id="cantidad0_0'+$codigo+'">('+$valor_cantidad+') \t '+$txt_nombre_generico+'</span></div>';
				else
				$item_nombre =  '<div class="item_nombre_corto f_left"><img src="images/borrar2.png" width="25" height="25" onclick="del_item(\''+$codigo+'\')" class="hand" style="top: 5px; position: relative;"><span id="cantidad0_0'+$codigo+'">('+$valor_cantidad+') \t '+$txt_nombre_generico+'</span></div>';
  ...
  $.ajax({
   ...
   success: function(datos){ 
	  ...
	  if(obj.status == "existe"){
		  ...
		  if(obj.cantidad < parseInt($valor_cantidad)){
		  ...
		  if(obj.nombre.length >= 48)
		  	$item_nombre =  '<div class="item_nombre f_left"><img src="images/borrar2.png" width="25" height="25" onclick="del_item(\''+obj.codigo+'\')" class="hand" style="top: 5px; position: relative;"><span id="cantidad0_0'+obj.codigo+'">('+obj.cantidad+') \t '+obj.nombre+'</span></div>';
		  else
		  	$item_nombre =  '<div class="item_nombre_corto f_left"><img src="images/borrar2.png" width="25" height="25" onclick="del_item(\''+obj.codigo+'\')" class="hand" style="top: 5px; position: relative;"><span id="cantidad0_0'+obj.codigo+'">('+obj.cantidad+') \t '+obj.nombre+'</span></div>';
		  ...
		  $table_precio = "<table border='0' width='100%' height='60'><tr><td width='70%'>"+$item_nombre+"</td><td width='30'>"+$thumb+"</td><td width='120' align='right'>"+$mayoreo+" "+$del_cantidad+" "+$add_cantidad+"</td><td width='20' align='right'>"+$caja_cantidad+"</td><td width='50' align='right'>"+$caja_precio_item+$caja_precioMayoreo_item+"</td></tr></table>"
