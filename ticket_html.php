...
foreach ($array_ids as $key => $id) {
	$tr .= '<tr  style="border-bottom:1px solid #000">
				<td>'.$array_cantidad_solicitada[$key].'</td><td>'.$conn->get_nombre_producto($id,30).'</td><td align="center" align="center">'.$array_precio_prod[$key]."</td>
...
?>
	...
	<tr>
		<td colspan="2" align="center"> PASTELERIA ARCE </td>
	</tr>	
	<tr>
    ...
    <table width="200" border="0" style="font-size:7px">
		<tr bgcolor="#CCCCCC">
			<th width="100" align="center" colspan="2">Producto</th><th width="25" align="center">Cant.</th>
		</tr>	
		<?=$tr?>
		<tr bgcolor="#CCCCCC">
			<th width="100" align="right" colspan="2">Total:</th><th width="25" align="center"><?=$total;?></th>
		</tr>        
